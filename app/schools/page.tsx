  ...
  return (
    <>
      ...
      <div className="sp">
        ...
        <section className="min-h-[calc(85vh-4rem)] relative flex items-center overflow-hidden" style={{ background: 'linear-gradient(165deg, #0f1a3c 0%, #1a0e2e 40%, #2d1b4e 100%)' }}>
