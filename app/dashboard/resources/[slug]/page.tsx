...
export default async function ParentResourceDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="mfa-editorial bg-white -m-4 sm:-m-6 pb-24 sm:pb-16">
      ...
      {/* Editorial body typography — applied via .mfa-body to dangerouslySetInnerHTML output */}
      <style jsx global>{`
        .mfa-body {
        ...
        .mfa-body p:first-of-type::first-letter {
          /* drop-cap-esque emphasis on first paragraph */
          font-weight: 700;
        }
