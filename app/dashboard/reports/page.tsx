          ...
          <div ref={printRef} className="bg-white border border-gray-100 rounded-xl overflow-hidden print:border-none print:rounded-none print:shadow-none">
            ...
            <div className="bg-gradient-to-r from-navy-700 to-navy-500 text-white p-6 print:p-8">
              <div className="flex items-start justify-between">
                <div>
                  <div className="text-xs font-medium text-warm-100 uppercase tracking-widest mb-1">Montessori Family Alliance</div>
            ...
            <div className="p-6 print:p-8 space-y-6">
              ...
              <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                <div className="text-xs text-gray-400">
                  Generated by Montessori Family Alliance · {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                </div>
                <div className="text-xs text-gray-400">
